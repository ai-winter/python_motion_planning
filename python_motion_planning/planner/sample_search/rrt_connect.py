            ...
            if node_new:
                ...
                if node_new_b:
                    ...
                    while True:
                        if node_new_b == node_new:
                            ...
                            return path, [
                                ...
                                {"type": "path", "name": "line", "data": [
                                    [[n.parent.x(), n.x], [n.parent.y(), n.y]] for n in expand
                        ...
                        node_new_b2 = Node(
                            Point3d(node_new_b.x + dist * math.cos(theta),
                                    node_new_b.y + dist * math.sin(theta)),
                            node_new_b.current, node_new_b.g + dist, 0
                        )
                        if not self.collision_checker(node_new_b2.current, node_new_b.current):
